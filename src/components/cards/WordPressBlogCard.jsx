  ...
  return (
    <div>
      <MotionDivDownToUp>
        <div
          id="cardBlog"
          className="w-[290px] phone2:w-[300px] phone3:w-[350px] tablet1:w-[400px] font-mainFont flex flex-col desktop1:max-w-[500px] desktop3:max-w-[375px] desktop4:max-w-[215px] bg-bgSectionLight rounded-2xl p-[20px]"
        >
          <div className="w-full max-h-[220px] tablet1:h-[300px] desktop4:h-[150px] flex justify-center items-center overflow-hidden rounded-2xl">
